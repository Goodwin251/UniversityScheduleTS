...
import { Professor, Classroom, Course, Lesson, DayOfWeek, TimeSlot, CourseType } from './types.js';

const uniSchedule = new UniSchedule();

if (typeof window == "undefined") {
    // Додавання професорів
    const professor1: Professor = { id: 1, name: "Dr. Kovalenko", department: "Computer Science" };
    const professor2: Professor = { id: 2, name: "Prof. Johnsonuk", department: "Mathematics" };
    ...
    const course2: Course = { id: 2, name: "Advanced Mathematics", type: "Seminar" };
    ...
    function updateTables() {
        ...
        const scheduleTableBody = documentRef.querySelector('#schedule-table tbody') as HTMLTableSectionElement;
        ...
        const courseTableBody = documentRef.querySelector('#course-table tbody') as HTMLTableSectionElement;
        ...
        const professorTableBody = documentRef.querySelector('#professor-table tbody') as HTMLTableSectionElement;
        ...
        const classroomTableBody = documentRef.querySelector('#classroom-table tbody') as HTMLTableSectionElement;
    ...
    function getDayOrder(day: DayOfWeek): number {
        const daysOrder = {
            "Monday": 1,
            "Tuesday": 2,
            "Wednesday": 3,
    ...
    function getTimeOrder(timeSlot: TimeSlot): number {
    ...
    function updateProfessorAndClassroomSelection() {
        const professorSelect = documentRef.getElementById('lesson-professor') as HTMLSelectElement;
        const classroomSelect = documentRef.getElementById('lesson-classroom') as HTMLSelectElement;
    ...
    function updateCourseSelection() {
        const lessonCourseSelect = documentRef.getElementById('lesson-course') as HTMLSelectElement;
    ...
    const addLessonForm = documentRef.getElementById('add-lesson-form') as HTMLFormElement;
    addLessonForm.addEventListener('submit', (event) => {
        event.preventDefault();
        const courseId = +(documentRef.getElementById('lesson-course') as HTMLSelectElement).value;
        const professorId = +(documentRef.getElementById('lesson-professor') as HTMLSelectElement).value;
        const classroomNumber = (documentRef.getElementById('lesson-classroom') as HTMLSelectElement).value;
        const dayOfWeek = (documentRef.getElementById('lesson-day') as HTMLSelectElement).value as DayOfWeek;
        const timeSlot = (documentRef.getElementById('lesson-timeslot') as HTMLSelectElement).value as TimeSlot;
    ...
    const addCourseForm = documentRef.getElementById('add-course-form') as HTMLFormElement;
    addCourseForm.addEventListener('submit', (event) => {
        event.preventDefault();
        const name = (documentRef.getElementById('course-name') as HTMLInputElement).value;
        const type = (documentRef.getElementById('course-type') as HTMLSelectElement).value as CourseType;
    ...
    const addProfessorForm = documentRef.getElementById('add-professor-form') as HTMLFormElement;
    addProfessorForm.addEventListener('submit', (event) => {
        event.preventDefault();
        const id = +(documentRef.getElementById('professor-id-input') as HTMLInputElement).value;
        const name = (documentRef.getElementById('professor-name') as HTMLInputElement).value;
        const department = (documentRef.getElementById('professor-department') as HTMLInputElement).value;
    ...
    const addClassroomForm = documentRef.getElementById('add-classroom-form') as HTMLFormElement;
    addClassroomForm.addEventListener('submit', (event) => {
        event.preventDefault();
        const number = (documentRef.getElementById('classroom-number') as HTMLInputElement).value;
        const capacity = +(documentRef.getElementById('classroom-capacity') as HTMLInputElement).value;
        const hasProjector = (documentRef.getElementById('classroom-projector') as HTMLInputElement).checked;
    ...
    documentRef.getElementById('get-utilization-button')!.addEventListener('click', () => {
        const classroomNumber = (documentRef.getElementById('classroom-utilization-number') as HTMLInputElement).value;
        const utilization: number = uniSchedule.getClassroomUtilization(classroomNumber);
    ...
    documentRef.getElementById('get-popular-course-button')!.addEventListener('click', () => {
        const popularCourseType: CourseType = uniSchedule.getMostPopularCourseType();
    ...
    documentRef.getElementById('reassign-classroom-button')!.addEventListener('click', () => {
        const lessonId: number = +(documentRef.getElementById('lesson-id') as HTMLInputElement).value;
        const newClassroomNumber: string = (documentRef.getElementById('new-classroom') as HTMLInputElement).value;
        const success: boolean = uniSchedule.reassignClassroom(lessonId, newClassroomNumber);
    ...
    documentRef.getElementById('cancel-lesson-button')!.addEventListener('click', () => {
        const lessonId: number = +(documentRef.getElementById('cancel-lesson-id') as HTMLInputElement).value;
    ...
    documentRef.getElementById('find-available-classrooms-button')!.addEventListener('click', () => {
        const timeSlot: TimeSlot = (documentRef.getElementById('available-classroom-timeslot') as HTMLSelectElement).value as TimeSlot;
        const dayOfWeek: DayOfWeek = (documentRef.getElementById('available-classroom-day') as HTMLSelectElement).value as DayOfWeek;
        const availableClassrooms: string[] = uniSchedule.findAvailableClassrooms(timeSlot, dayOfWeek);
    ...
    documentRef.getElementById('get-professor-schedule-button')!.addEventListener('click', () => {
        const professorId: number = +(documentRef.getElementById('professor-id-schedule') as HTMLInputElement).value;
        const professorSchedule: Lesson[] = uniSchedule.getProfessorSchedule(professorId);
